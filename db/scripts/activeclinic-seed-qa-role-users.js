...
async function main() {
  ...
  try {
    ...
    const matrix = (result.verifications || []).map((v) => ({
      ...
      emailPhoneMatch: v.emailPhoneMatch,
      phoneResolveOk: v.phoneResolveOk,
      staffPhoneMatches: v.staffPhoneMatches,
      nav: v.navModules,
    ...
    emit({
      ...
      emailPhoneMatchCount: result.emailPhoneMatchCount,
      phoneResolveOkCount: result.phoneResolveOkCount,
      phoneUpdated: result.phoneUpdated,
      phoneAlreadyCorrect: result.phoneAlreadyCorrect,
      ...
      julflonaQaPhoneIdentityCount: result.julflonaQaPhoneIdentityCount,
