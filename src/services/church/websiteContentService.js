...
function buildBranchFallbacks(org, branch) {
  ...
  return {
    ...
    service_times: (branch && branch.service_times) || "Sunday Worship · 9:00 AM",
    ...
    giving_bank_details: "",
    giving_mobile_money: "",
    giving_categories: "Tithes, Offerings, Missions, Building Fund",
    giving_instructions:
      "Your generosity supports ministry, outreach, and community care. Giving information is managed by branch leadership.",
