...
const PAGE_ID = Object.freeze({
  ...
  [STATE.FACILITY_UNAVAILABLE]: "facility-unavailable",
...
const PRESETS = Object.freeze({
  ...
  [STATE.FACILITY_UNAVAILABLE]: {
    pageTitle: "No facility available",
    heading: "No facilities available",
    message: "You do not have an active facility assignment. Ask an administrator for access.",
    primaryHref: "/app",
    primaryLabel: "Back to home",
    httpStatus: 403,
  },
