...
const COVERAGE = Object.freeze([
  ...
  { page: "services", section: "Actual service list", classification: C.OPERATIONAL_DATA, contentKey: null, editable: false, source: "appointment_service_types via public catalogue", manageHref: "/app/settings/website/catalogue?tab=services" },
  { page: "services", section: "Actual procedure list", classification: C.OPERATIONAL_DATA, contentKey: null, editable: false, source: "clinic procedures (managed with services catalogue when published)", manageHref: "/app/settings/website/catalogue?tab=services" },
