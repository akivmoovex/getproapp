...
function createActiveClinicFoundationApp(options) {
  ...
  } = require("./activeClinicRoomRoutes");
  registerActiveClinicRoomRoutes(app, { getPool, env, isProduction });
  ...
  registerActiveClinicWebsiteCmsRoutes(app, { getPool, env, isProduction });
  const {
