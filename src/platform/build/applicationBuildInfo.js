 ...
 *   productVersion  → "2.0"
 *   versionBase     → "2.0"
 *   version         → "2.0" (Git SHA is shown separately as `build`; no invented build number)
 */
...
/** System / product version for V8 (GetPro V2.0 line). */
const VERSION_BASE_V8 = "2.0";
const PRODUCT_VERSION_V8 = "2.0";
