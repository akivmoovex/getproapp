...
Public visual work is frozen at **`/church/church.css?v=40`**. Do not ship new visual features before the pilot.
...
| 3 | **Build assets** — `npm run build` or `npm run build:assets` | CSS/JS bundles present; public pages load `church.css?v=40` |
...
| `https://demo.blessboard.com` | Demo church homepage (`church.css?v=40`) |
