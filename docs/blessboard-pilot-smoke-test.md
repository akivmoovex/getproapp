...
| F13 | CSS v36 | View source on public shells | `church.css?v=40` | Pass |
...
| 2 | https://demo.blessboard.com | 200 | Demo church homepage; `church.css?v=40` | 404 Church not found | Run demo seed on boot; check `church_branches.host_slug = demo` |
