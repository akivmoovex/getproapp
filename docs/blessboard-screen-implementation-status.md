...
| Church detail | Desktop/Mobile | `65` (nearest) | `/admin/churches/:id` | `admin/church/organization_detail.ejs` | v42 | Shell-aligned | Uses platform shell; welcome handoff still clears after first view; **Create HQ Admin** → `/admin/churches/:id/hq-admins/new` |
...
| Create HQ admin | Desktop/Mobile | — | `/admin/churches/:id/hq-admins/new` | `admin/church/hq_admin_form.ejs` | v42 | Shell-aligned | Platform-created only; legacy `/admin/church/organizations/:id/hq-admins/new` redirects; table `church_hq_admins` |
